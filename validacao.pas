...
function TQualTriangulo.ValidaTrianguloEquilatero(ladoA, LadoB, //fazer teste
...
function TQualTriangulo.ValidaTrianguloEscaleno(ladoA, LadoB, //fazer testes
  LadoC: Integer): string;
begin
  if ((ladoA + LadoB) > LadoC) or ((ladoA + LadoC) > LadoB) or ((LadoB + LadoC)> ladoA)  then
  begin
...
function TQualTriangulo.ValidaTrianguloIsosceles(ladoA, LadoB, //Resolvido
  LadoC: Integer): string;
begin
  if ((ladoA + LadoB) > LadoC) or ((ladoA + LadoC) > LadoB) or ((LadoB + LadoC)> ladoA)  then
  begin
